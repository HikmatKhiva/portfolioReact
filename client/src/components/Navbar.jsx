      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          <a href="#home" className="cursor-pointer">
            <h1 className="text-2xl font-medium text-gray-600 hover:text-gray-700 transition-all duration-300 hover:scale-110 dark:hover:text-gray-300  dark:text-gray-400">Hikmat</h1>
          </a>
        </div>
