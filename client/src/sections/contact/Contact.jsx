    ...
    <section className="flex-grow overflow-hidden dark:text-white py-10">
      ...
      <div className="form__center mt-4 xl:mt-24 flex items-center justify-center">
        <form
          ...
          className="contact__form  flex flex-col w-10/12 gap-4 md:w-96"
        >
          <input
            type="email"
            name="email"
          ...
          />
          <textarea
            className="border-b text-sm md:text-xl border-gray-500 dark:text-white text-gray-700 placeholder:text-gray-700 dark:placeholder:text-white bg-transparent outline-none py-3 h-36 md:h-52 resize-none"
...
export default MotionWrap(
  Contact,
  "contact w-full items-center h-full",
  "contact"
);